...
* Temptation (para manipular emoções e intenções)
* Shadow Step (teleporte entre sombras)
* Abyssal Flame (chamas negras que consomem tudo)
* Contract (habilidade para formar pactos demoníacos)
...
* Gravity Bind
* Spatial Severance
* Summon Demonic Servants

---

## 🛡️ Resistências e Habilidades Passivas

* Nullificação de dor
* Resistência a ataques físicos e mágicos
* Imunidade mental
...
* Combate corpo a corpo refinado
* Magia negra de altíssimo nível
* Manipulação de barreiras e espaço
* Utiliza táticas de dominação e destruição gradual
